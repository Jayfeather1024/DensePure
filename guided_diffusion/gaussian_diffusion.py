...
class GaussianDiffusion:
    ...
    def __init__(
        ...
        *,
        ...
        self.alphas_cumprod_origin = self.alphas_cumprod.copy()
    ...
    def p_mean_variance(
        self, model, x, t, clip_denoised=True, denoised_fn=None, model_kwargs=None, real_t = None
    ):
        """
        ...
        if indices_t_steps!=None:
            if step==len(indices_t_steps):
                ...
                for i in range(len(indices_t_steps)-1):
                    ...
                    betas.append(min(1 - self.alphas_cumprod_origin[t2] / self.alphas_cumprod_origin[t1], 0.999))
